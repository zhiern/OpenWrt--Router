...
sed -i 's/OpenWrt/Redmi AX6000/' package/base-files/files/bin/config_generate
...
# 修改WiFi名称
sed -i 's/set wireless.default_${name}.ssid=OpenWrt/set wireless.default_${name}.ssid=RedmiAX6000/' package/kernel/mac80211/files/lib/wifi/mac80211.sh
